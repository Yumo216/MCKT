...
from KnowledgeTracing.model.BiSSMs.selective_scan import selective_scan_fn, mamba_inner_fn, bimamba_inner_fn, mamba_inner_fn_no_out_proj
        ...
        if self.use_fast_path and inference_params is None:  # Doesn't support outputting the states
            if self.bimamba_type == "v1":
                ...
                if not self.if_devide_out:
                    ...
                    out = F.linear(rearrange(0.5 * out + 0.5 * out_b.flip([-1]), "b d l -> b l d"),
